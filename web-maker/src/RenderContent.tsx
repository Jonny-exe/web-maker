	...
	return (
		<>{
			props.content.map((x: any, i: number) => (x.type === "img" ? <img src={x.src} style={x.style} alt="Image" /> : React.createElement(x.type, {
				...
				x.children !== null && x.children !== undefined && x.children.length !== 0 ? <RenderContent1 content={x.children} setModalEditPlacementActive={props.setModalEditPlacementActive} previewMode={props.previewMode} setSavedStyle={props.setSavedStyle} setItemIndex={props.setItemIndex} itemIndex={props.itemIndex} savedStyle={props.savedStyle} /> : x.content,
