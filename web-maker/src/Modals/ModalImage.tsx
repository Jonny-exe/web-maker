	...
	return (
		<div className="imageModalContainer">
			...
			<div className={`addImageModal modal ${props.addImageOverlayActive ? "modalActive" : ""}`}>
				...
				<input type="text" className={`input ${props.previewMode ? "previewMode" : ""}`} value={props.imageSrc} placeholder="https:you-image-url" onChange={(e: any) => props.setImageSrc(e.target.value)} />
				...
				<button className="preview loginButton modalImageButton" onClick={() => {
